Public Class Form3
    ...
    Private Sub Buttonp_Click(sender As Object, e As EventArgs) Handles Buttonp.Click
        ...
        End If
    End Sub
    Private Sub AreaCuadrado_Click(sender As Object, e As EventArgs) Handles AreaCuadrado.Click
        EvaluayHazOperacion()
        Operacion = "c"
    End Sub
    Private Sub AreaRectangulo_Click(sender As Object, e As EventArgs) Handles AreaRectangulo.Click
        EvaluayHazOperacion()
        Operacion = "r"
    End Sub
    Private Sub AreaTriangulo_Click(sender As Object, e As EventArgs) Handles AreaTriangulo.Click
        EvaluayHazOperacion()
        Operacion = "t"
    End Sub
    ...
    Public Sub EvaluayHazOperacion()
        ...
        If ValorResultado IsNot Nothing Then
            Select Case Operacion
                Case "c"
                    ValorResultado = ValorResultado * ValorResultado
                Case "r"
                    ValorResultado = ValorResultado * Valor2
                Case "t"
                    ValorResultado = (ValorResultado * Valor2) / 2
